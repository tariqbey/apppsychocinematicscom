  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Upload a photo of yourself to automatically appear as the main character in all AI-generated images across Mind Movies, Challenges, and Episodes.
        </CardDescription>
      </CardHeader>
          ...
          <div className="space-y-4">
            ...
            <Card className="p-3 bg-gold/5 border-gold/20">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium">Active across all generations</p>
                  <p className="text-xs text-muted-foreground mt-1">
                    Your reference photo will be used in Mind Movies, Challenge Storyboards, and Episode visualizations.
                  </p>
                </div>
              </div>
            </Card>
          ...
          <div className="space-y-4">
            ...
            <Card className="p-3 bg-muted/50">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium">Why add a reference photo?</p>
                  <p className="text-xs text-muted-foreground mt-1">
                    The AI will use your likeness to generate scenes where YOU are the main character, creating a more powerful visualization experience.
                  </p>
                </div>
              </div>
            </Card>
