...
import { Target, X, Crown, Zap, Swords, Quote, Scale, Sparkles, User2, Sun, Moon, Flame, Star } from "lucide-react";
                ...
                <div className="flex flex-wrap gap-2">
                  {archetype.signatureTraits.map((trait, index) => (
                    <Badge 
                      key={index} 
                      variant="secondary"
                      className="bg-gold/10 text-gold border-gold/30 px-3 py-1"
                    >
                      {trait}
                    </Badge>
                  ))}
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Card className="glass-card border-amber-400/30">
                <CardHeader className="pb-2">
                  ...
                  <p className="text-xs text-muted-foreground">Your highest potential</p>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">{archetype.lightExpression}</p>
                </CardContent>
              </Card>
              ...
              <Card className="glass-card border-purple-500/30">
                <CardHeader className="pb-2">
                  ...
                  <p className="text-xs text-muted-foreground">Distorted patterns to watch</p>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">{archetype.shadowExpression}</p>
                </CardContent>
              </Card>
            </div>

            {/* Story Fuel */}
            <Card className="glass-card border-orange-500/30 bg-gradient-to-br from-orange-500/5 to-red-500/5">
              <CardHeader className="pb-2">
                <CardTitle className="text-lg font-display tracking-wide flex items-center gap-2">
                  <Flame className="h-5 w-5 text-orange-400" />
                  Story Fuel
                </CardTitle>
                <p className="text-xs text-muted-foreground">The dramatic conflict that drives your transformation</p>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground italic">{archetype.storyFuel}</p>
              </CardContent>
            </Card>
